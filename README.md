...
### 🥤 [HW1: Juice Machine CLI](./HW1-JuiceMachine)
A command-line interface simulating a juice ordering system with dynamic pricing logic.
- **Highlights:** User input validation, loop controls.
- **Fun Fact:** Features a custom greeting inspired by **Squid Game** & *Thanos* memes.

### 🃏 [HW2: Arisu's Borderland Adventure](./HW2-ArisuAdventure)
A text-based RPG survival game themed around the series **Alice in Borderland**.
- **Highlights:** Global state management, file logging (`treasure_log.txt`), branching storylines.
- **Story:** You play as **Arisu**, making life-or-death decisions to survive the borderland.

### 📊 [HW3: Data Analysis Tool](./HW3-DataAnalysis)
A script designed to parse, clean, and analyze raw text data from students and inventory logs.
- **Highlights:** Data cleaning, string manipulation, statistical calculations using Tuples & Lists.
